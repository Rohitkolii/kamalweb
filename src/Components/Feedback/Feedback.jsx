    ...
    <>
        <section className={Styles.Feedback}>
            <div className={Styles.col1}>
                ...
                <h3 className='gt'>Hear It from Those Who Know Us Best</h3>
